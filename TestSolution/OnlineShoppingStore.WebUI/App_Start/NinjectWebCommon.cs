...
namespace OnlineShoppingStore.WebUI.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            {
                new Product {Name = "Football", Price = random.Next(10, 50)},
                new Product {Name = "Surf board", Price = random.Next(10, 50)},
                new Product {Name = "Lenovo Y51", Price = random.Next(10, 50)},
                new Product {Name = "Adidas Shoes", Price = random.Next(10, 50)},
            });
